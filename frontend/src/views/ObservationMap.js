  ...
  render() {
    ...
    return (
      <Menus activePage={activePage} handlePageChange={handlePageChange} observationsChange={this.observationsChanged}>
        ...
        <span className="haliho">Choose a date interval to know in that time where the amateurs reported dusty air from to provide control data for satellite images!</span>
